...
if(isset($_POST['btn-signup']))
{
    ...
    $establishmentName = trim($_POST['txtestablishmentname']);
    ...
    {
        if($reg_user->register($uname,$email,$upass,$code,$establishmentName, $contactPerson, $mobnum))
        {           
            $id = $reg_user->lasdID();      
    ...
    <div class="reg-block-signup">
        ...
        <form method="POST">
            ...
            <div class="input-group margin-bottom-20">
                ...
                <input type="text" class="form-control" placeholder="Establishment Name" name="txtestablishmentname" required>
            </div>
            <div class="input-group margin-bottom-20">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" class="form-control" placeholder="Contact Person" name="txtcontactperson" required>
            </div>
            <div class="input-group margin-bottom-20">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <button type="submit" class="btn-u btn-block" name="btn-signup">Register</button>
                </div>
            </div>
        </form>
    </div>
