...
<html ng-app="storeApp">
	...
	<body id="home">
			...
			<div class="container welcome-content">
				<div class="row">
					<div class="col-lg-5 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 text-center wow fadeInUp">
						...
						<a class="btn btn-store smooth-scroll" href="login.php">Login</a>
						<a class="btn btn-store smooth-scroll" href="registration.php">Register</a>
					</div>
				</div>
			</div>
		...
		<!--=== Content ===-->
	    <div class="content-md" id="what-we-provide">
	        <div class="container">
	            ...
	            <div class="row margin-bottom-40">
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 margin-bottom-30">
	                        <i class="rounded-x fa fa-gift"></i>
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">No Cylinder Deposit</h3>
	                            <p>Yes, you heard it right, no cylinder deposit. We would like you to use that money for something more productive.</p>
	                        </div>
	                    </div>
	                </div>
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 margin-bottom-30">
	                        ...
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">Lower Gas Cost</h3>
	                            <p>If you thought the “No Deposit” was a sweet deal, wait till you hear our Gas prices.</p>
	                        </div>
	                    </div>
	                </div>
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 margin-bottom-30">
	                        <i class="rounded-x fa fa-cut"></i>
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">Lower Gas Consumption</h3>
	                            <p>Apart from lower costs, we will help you reduce your overall gas consumption.  Yes, cost savings & efficient combustion-we offer you best of both worlds!</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 md-margin-bottom-30">
	                        <i class="rounded-x fa fa-inr"></i>
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">No Tips!</h3>
	                            <p>We are all too familiar with the scenario where if you did not “tip” the Gas delivery personnel, the dependability was always in questions. With GasMarket, this pain will be a thing of the past with our ‘No Tips’ policy.</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 md-margin-bottom-30">
	                        ...
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">User Friendly Interface</h3>
	                            <p>You can order your Gas supplies from your mobile phone, tablet, and desktop or laptop computer from anywhere & anytime.</p>
	                        </div>
	                    </div>
	                </div>
	                <div class="col-md-4">
	                    <div class="content-boxes-v5 margin-bottom-30">
	                        <i class="rounded-x fa fa-phone "></i>
	                        <div class="overflow-h">
	                            <h3 class="no-top-space">Active Support</h3>
	                            <p>With GasMarket gone are the days when you would have to put with undeservingly poor service standards. Our support team is always by your side for any eventuality or support that you may require.</p>
	                        </div>
	                    </div>
	                </div>
	            </div><!--/end row-->
	        ...
	        <!-- <div class="flat-testimonials bg-image-v1 parallaxBg1 margin-bottom-60" id="testimonial">
	            <div class="container">
	                <div class="headline-center headline-light margin-bottom-60">
	                    ...
	                    <p>Integer odio ligula, tincidunt id volutpat et, imperdiet eget mi. Quisque laoreet porttitor turpis sed fermentum. Nullam sodales blandit nisi, tristique tempor nunc hendrerit at. Sed posuere mollis orci</p>
	                </div>
	    ...
	    <section id="contact" class="contacts-section">
	        <div class="container content-lg">
	            ...
	            <div class="row contacts-in">
	                ...
	                <div class="col-md-6">
	                    <form action="send-mail-index.php" method="post" id="sky-form3" class="sky-form contact-style">
	                        <fieldset>
